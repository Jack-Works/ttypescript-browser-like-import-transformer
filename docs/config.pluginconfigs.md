...
|  [bareModuleRewrite](./config.pluginconfigs.baremodulerewrite.md) | <code>false &#124; BareModuleRewriteSimple &#124; BareModuleRewriteURL &#124; Record&lt;string, BareModuleRewriteObject&gt;</code> | The transformation rule. Specify how this transformer will handle your imports. |
...
|  [importHelpers](./config.pluginconfigs.importhelpers.md) | <code>'inline' &#124; 'auto' &#124; string</code> | Import emit helpers (e.g. <code>\__UMDBindCheck</code>, <code>\__dynamicImportTransform</code>, etc..) from ttsclib (a local file in this package). |
