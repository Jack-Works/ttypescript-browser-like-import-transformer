...
const y = '';
__dynamicImportTransform(y, JSON.parse("{\"after\":true,\"bareModuleRewrite\":{\"enum\":\"snowpack\",\"type\":\"simple\"}}"), __dynamicImportNative, __UMDBindCheck, moduleSpecifierTransform);
