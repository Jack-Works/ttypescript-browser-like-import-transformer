...
__dynamicImportTransform_1(`./file${''}.json`, JSON.parse("{\"jsonImport\":\"inline\"}"), __dynamicImportNative_1, _import_1, moduleSpecifierTransform_1).then((x) => console.log('Nondeterministic dynamic import', x));
...
import { __esModuleInterop as __esModuleInterop_1, __dynamicImportTransform as __dynamicImportTransform_1, _import as _import_1, moduleSpecifierTransform as moduleSpecifierTransform_1 } from "https://cdn.jsdelivr.net/npm/@magic-works/ttypescript-browser-like-import-transformer@3.0.2/es/ttsclib.min.js";
