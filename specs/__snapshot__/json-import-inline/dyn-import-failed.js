// @ts-ignore
__dynamicImportTransform('./not-found.json', JSON.parse("{\"jsonImport\":\"inline\"}"), __dynamicImportNative, _import, moduleSpecifierTransform).then(console.log, console.error);
// @ts-ignore
__dynamicImportTransform('https://raw.githubusercontent.com/angular/angular-cli/master/packages/angular/cli/lib/config/schema.json', JSON.parse("{\"jsonImport\":\"inline\"}"), __dynamicImportNative, _import, moduleSpecifierTransform).then(console.log, console.error);
// @ts-ignore
