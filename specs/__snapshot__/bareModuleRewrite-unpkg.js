...
const y = '';
__dynamicImportTransform(y, JSON.parse("{\"after\":true,\"bareModuleRewrite\":{\"enum\":\"unpkg\",\"type\":\"simple\"}}"), __dynamicImportNative, __UMDBindCheck, moduleSpecifierTransform);
